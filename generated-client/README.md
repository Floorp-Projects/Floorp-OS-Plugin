...
*DefaultApi* | [**close_tab**](docs/DefaultApi.md#close_tab) | **POST** /tabs/instances/{id}/close | Close tab (destroy instance and close browser tab)
...
*DefaultApi* | [**dispatch_scraper_event**](docs/DefaultApi.md#dispatch_scraper_event) | **POST** /scraper/instances/{id}/dispatchEvent | Dispatch event on element
*DefaultApi* | [**dispatch_tab_event**](docs/DefaultApi.md#dispatch_tab_event) | **POST** /tabs/instances/{id}/dispatchEvent | Dispatch event on element in tab
...
*DefaultApi* | [**get_current_workspace**](docs/DefaultApi.md#get_current_workspace) | **GET** /workspaces/current | Get current workspace ID
...
*DefaultApi* | [**input_scraper_element**](docs/DefaultApi.md#input_scraper_element) | **POST** /scraper/instances/{id}/input | Type into an element
*DefaultApi* | [**input_tab_element**](docs/DefaultApi.md#input_tab_element) | **POST** /tabs/instances/{id}/input | Type into an element in tab
...
*DefaultApi* | [**list_workspaces**](docs/DefaultApi.md#list_workspaces) | **GET** /workspaces | List all workspaces
...
*DefaultApi* | [**press_scraper_key**](docs/DefaultApi.md#press_scraper_key) | **POST** /scraper/instances/{id}/pressKey | Press key or key combination
*DefaultApi* | [**press_tab_key**](docs/DefaultApi.md#press_tab_key) | **POST** /tabs/instances/{id}/pressKey | Press key or key combination in tab
...
*DefaultApi* | [**set_scraper_inner_html**](docs/DefaultApi.md#set_scraper_inner_html) | **POST** /scraper/instances/{id}/setInnerHTML | Set innerHTML of element
*DefaultApi* | [**set_scraper_text_content**](docs/DefaultApi.md#set_scraper_text_content) | **POST** /scraper/instances/{id}/setTextContent | Set textContent of element
...
*DefaultApi* | [**set_tab_inner_html**](docs/DefaultApi.md#set_tab_inner_html) | **POST** /tabs/instances/{id}/setInnerHTML | Set innerHTML of element in tab
*DefaultApi* | [**set_tab_text_content**](docs/DefaultApi.md#set_tab_text_content) | **POST** /tabs/instances/{id}/setTextContent | Set textContent of element in tab
...
*DefaultApi* | [**switch_to_next_workspace**](docs/DefaultApi.md#switch_to_next_workspace) | **POST** /workspaces/next | Switch to next workspace
*DefaultApi* | [**switch_to_previous_workspace**](docs/DefaultApi.md#switch_to_previous_workspace) | **POST** /workspaces/previous | Switch to previous workspace
*DefaultApi* | [**switch_to_workspace**](docs/DefaultApi.md#switch_to_workspace) | **POST** /workspaces/{workspaceId}/switch | Switch to specific workspace
...
*DefaultApi* | [**upload_scraper_file**](docs/DefaultApi.md#upload_scraper_file) | **POST** /scraper/instances/{id}/uploadFile | Upload file via input[type=file]
*DefaultApi* | [**upload_tab_file**](docs/DefaultApi.md#upload_tab_file) | **POST** /tabs/instances/{id}/uploadFile | Upload file via input[type=file] in tab
...
## Documentation For Models
 ...
 - [CurrentWorkspaceResponse](docs/CurrentWorkspaceResponse.md)
 - [DispatchEventRequest](docs/DispatchEventRequest.md)
 - [DispatchEventRequestOptions](docs/DispatchEventRequestOptions.md)
